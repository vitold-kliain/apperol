...
gulp.task('watch', function (done) {
  ...
  gulp.watch([paths.pages.htmlAll], {
    cwd: './'
...
gulp.task('default', gulp.series('clean:dist', 'copy-assets', gulp.series('html', 'sass', 'fileinclude', 'sass-min', 'bootstrapjs', 'mrarejs'), gulp.series('serve', 'watch')));
gulp.task('build', gulp.series('clean:dist', 'copy-assets', gulp.series('html', 'sass', 'fileinclude', 'sass-min', 'bootstrapjs', 'mrarejs')));
